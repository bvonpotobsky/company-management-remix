      ...
      <div>
        <label className="flex w-full flex-col gap-1">
          ...
          <input
            ref={titleRef}
            name="title"
            className="flex-1 rounded-sm border-2 border-blue-500 px-3 text-lg leading-loose"
      ...
      <div>
        <label className="flex w-full flex-col gap-1">
          ...
          <textarea
            ...
            name="body"
            rows={8}
            className="w-full flex-1 rounded-sm border-2 border-blue-500 px-3 py-2 text-lg leading-6"
